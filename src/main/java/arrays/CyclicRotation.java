...
public class CyclicRotation {
    public int[] solution(int[] A, int K) {
        ...
        for (int i = 0; i < K; i++) {
            ...
            // write other values but last (which was shifter
            System.arraycopy(A, 0, rotated, 1, A.length - 1);
            A = rotated;
        }
        return A;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution.solution(new int[] {3, 8, 9, 7, 6}, 3))); // should return: [9,7,6,3,8]
        System.out.println(Arrays.toString(solution.solution(new int[] {0, 0, 0}, 1))); // should return: [0,0,0]
        System.out.println(Arrays.toString(solution.solution(new int[] {1, 2, 3, 4}, 4))); // should return: [1,2,3,4]
    }
}
