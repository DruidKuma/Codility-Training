...
public class EquiLeader {
    ...
    public int solution(int[] A) {
        ...
        for (int i = 0; i < A.length; i++) {
            ...
            if(currentLeaders > leftLength / 2 && (count - currentLeaders) > rightLength / 2) result++;
        }
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.solution(new int[]{4, 3, 4, 4, 4, 2})); //should return 2
        System.out.println(solution.solution(new int[]{4, 4, 2, 5, 3, 4, 4, 4})); //should return 3
    }
